"""
Django settings for Quiz5 project.
...
SECRET_KEY = 'django-insecure-fv1e4$ws$ixi5$-i_5r7g$ygg87t^ijgx16@&+4btut+owk%%$'
...
WSGI_APPLICATION = 'Quiz5.wsgi.application'
